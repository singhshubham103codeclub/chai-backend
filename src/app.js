...
app.use(express.json({limit:"10mb"}))// Middleware to parse JSON request bodies with a size limit of 10mb
app.use(express.urlencoded({extended:true,limit:"10mb"}))// Middleware to parse URL-encoded request bodies with a size limit of 10mb
